...
{
    public class PruebasInitializer :
        //CreateDatabaseIfNotExists<LocalDBPruebasContext>
        DropCreateDatabaseIfModelChanges<LocalDBPruebasContext>
        //DropCreateDatabaseAlways<LocalDBPruebasContext>
    {
        protected override void Seed(LocalDBPruebasContext context)
        {
